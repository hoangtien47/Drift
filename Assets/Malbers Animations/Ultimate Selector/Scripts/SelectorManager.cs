...
namespace MalbersAnimations.Selector
{
    ...
    public class SelectorManager : MonoBehaviour
    {
        ...
        protected virtual void InstantiateItem()
        {
            ...
            Sync_Material_ActiveMeshes();    
			//Debug.Log (ItemSelected.gameObject.name);
			PlayerPrefs.SetString ("CurrentCar", ItemSelected.gameObject.name);//Sync all Material Changers on Item and Original GO
			Debug.Log (PlayerPrefs.GetString ("CurrentCar","Nothing"));
        }
